...
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/0fb8382fb3287a7699143.jpg")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "70"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/SJMxADITI/TRICKYABHI-MUSIC")
START_PIC = getenv("START_PIC", "https://telegra.ph/file/0cadf5aa66dec8cd4d1d3.jpg")
